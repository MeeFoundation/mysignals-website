...
description: MySignals lets people signal their intent, just by browsing.
button:
  enable: true
  label: "View Full Spec"
  link: "/spec/"
explanation: |
  ##### **MySignals is a protocol to allow a person to send signals to any website via their browser.**
