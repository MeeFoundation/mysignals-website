...
|---|---|---|
| `Sec-MS` | `X-MS` | §3.2 |
| `Sec-MS-Discovery` | `X-MS-Discovery` | §3.3 |
...
- The SDK surfaces the service provider's per-signal `Ack-MS` results (`Ack` / `Unknown` / `BadData`, §3.4) to the caller.
